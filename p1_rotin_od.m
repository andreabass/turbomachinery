...
V_1A_m = [2*V_1A(end) 1.1*V_1A(end)];
...
%         delta_od_IGV_iter(end-1) = delta_od_IGV_iter(end);
    ...
    while abs((rho_1_iter(end)-rho_1_iter(end-1))/rho_1_iter(end-1)) > tol
        ...
        Y_1_p_tot_iter = y_AM_od(alpha_1_geo_od_high(i),alpha_0_t,alpha_1_iter,sigma_IGV_t,alpha_1_iter-alpha_1_t_geo,rho_1_iter(end),b,c_IGV_t,V_1_iter,mu);
...
%         delta_od_IGV_iter(end-1) = delta_od_IGV_iter(end);
    ...
    while abs((rho_1_iter(end)-rho_1_iter(end-1))/rho_1_iter(end-1)) > tol
        ...
        Y_1_p_tot_iter = y_AM_od(alpha_1_geo_od_low(i),alpha_0_t,alpha_1_iter,sigma_IGV_t,alpha_1_iter-alpha_1_t_geo,rho_1_iter(end),b,c_IGV_t,V_1_iter,mu);
